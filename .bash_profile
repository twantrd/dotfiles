...
# ssh-agent
alias sshagent="exec /usr/bin/ssh-agent $SHELL"
export SSH_AUTH_SOCK=/tmp/ssh-jOdVDp9595/agent.9595
...
# Export path
export PATH=/Users/tnXXXX/bins:$PATH

# For ansible 2.4 (python) & OSX 10.13 security changes if updated from Sierra -> High Sierra
export OBJC_DISABLE_INITIALIZE_FORK_SAFETY=YES

# for accurate colors (nope, didn't do shiet)
export CLICOLOR=1
